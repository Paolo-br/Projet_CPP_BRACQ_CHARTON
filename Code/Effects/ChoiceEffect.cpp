...
const ResourceType* ChoiceEffect::getResourceType() const { return nullptr; }
const ConditionType* ChoiceEffect::getConditionType() const { return nullptr; }
bool ChoiceEffect::getIsOptional() const { return false; }
const std::string* ChoiceEffect::getCardTypeFilter() const { return nullptr; }
int ChoiceEffect::getCount() const { return 0; }
int ChoiceEffect::getMaxCount() const { return 0; }
Effect* ChoiceEffect::getBonusEffect() const { return nullptr; }
