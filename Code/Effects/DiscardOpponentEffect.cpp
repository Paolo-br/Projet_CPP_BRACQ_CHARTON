...
Effect* DiscardOpponentEffect::getOption1() const { return nullptr; }
Effect* DiscardOpponentEffect::getOption2() const { return nullptr; }
const ResourceType* DiscardOpponentEffect::getResourceType() const { return nullptr; }
const ConditionType* DiscardOpponentEffect::getConditionType() const { return nullptr; }
bool DiscardOpponentEffect::getIsOptional() const { return false; }
const std::string* DiscardOpponentEffect::getCardTypeFilter() const { return nullptr; }
int DiscardOpponentEffect::getCount() const { return 0; }
int DiscardOpponentEffect::getMaxCount() const { return 0; }
Effect* DiscardOpponentEffect::getBonusEffect() const { return nullptr; }
