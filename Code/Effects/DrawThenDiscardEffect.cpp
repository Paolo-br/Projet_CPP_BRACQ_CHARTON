...
std::string DrawThenDiscardEffect::getName() const { return "DrawThenDiscardEffect";}

Effect* DrawThenDiscardEffect::getOption1() const { return nullptr; }
Effect* DrawThenDiscardEffect::getOption2() const { return nullptr; }
const ResourceType* DrawThenDiscardEffect::getResourceType() const { return nullptr; }
const ConditionType* DrawThenDiscardEffect::getConditionType() const { return nullptr; }
bool DrawThenDiscardEffect::getIsOptional() const { return m_optional; }
const std::string* DrawThenDiscardEffect::getCardTypeFilter() const { return nullptr; }
int DrawThenDiscardEffect::getCount() const { return m_drawCount; }
int DrawThenDiscardEffect::getMaxCount() const { return m_discardCount; }
Effect* DrawThenDiscardEffect::getBonusEffect() const { return nullptr; }
