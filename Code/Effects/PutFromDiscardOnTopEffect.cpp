...
Effect* PutFromDiscardOnTopEffect::getOption1() const { return nullptr; }
Effect* PutFromDiscardOnTopEffect::getOption2() const { return nullptr; }
const ResourceType* PutFromDiscardOnTopEffect::getResourceType() const { return nullptr; }
const ConditionType* PutFromDiscardOnTopEffect::getConditionType() const { return nullptr; }
const std::string* PutFromDiscardOnTopEffect::getCardTypeFilter() const { return nullptr; }
int PutFromDiscardOnTopEffect::getCount() const { return 0; }
int PutFromDiscardOnTopEffect::getMaxCount() const { return 0; }
Effect* PutFromDiscardOnTopEffect::getBonusEffect() const { return nullptr; }
